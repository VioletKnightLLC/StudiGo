...
echo Linking...
link.exe /DLL /NOLOGO /OUT:"%OUTPUT_DIR%\GoProCamFilter.dll" /DEF:"%~dp0src\GoProCamFilter.def" /LIBPATH:"%SDK_PATH%\lib\%SDK_VER%\um\x64" /LIBPATH:"%VSTOOLSET%\lib\x64" kernel32.lib user32.lib advapi32.lib ole32.lib oleaut32.lib strmiids.lib uuid.lib
